...
> ⚠️ Chain names are case-insensitive.

> ⚠️ Some chains (e.g. BNB Smart Chain, Base, OP, Avalanche) require a paid API plan.
...
Like this:
    ...
    [root@hxzy test]#getCode -n "Ethereum Mainnet" -t 0x8dda3f4a1c4bbc85ed50d7a78096f805f2c9382e35800e42f066abaa7b17a71b -p 127.0.0.1:7890
